...
@Slf4j
public abstract class AiModelResource<C extends ResourceConfiguration, MODEL_RESULT, RESOURCE_RESULT, INPUT>
    extends AbstractConfigurableResource<C>
    implements ApplicationContextAware {

    protected Vertx vertx;
    protected ApplicationContext applicationContext;
    protected InferenceServiceClient<INPUT, MODEL_RESULT> inferenceServiceClient;
    ...
    public abstract Single<RESOURCE_RESULT> invokeModel(INPUT input);

    protected abstract InferenceServiceClient<INPUT, MODEL_RESULT> buildInferenceServiceClient();
    ...
    protected void fetchModel() {
        // We need to block the call to ensure the model is loaded before ending
        // initialization
