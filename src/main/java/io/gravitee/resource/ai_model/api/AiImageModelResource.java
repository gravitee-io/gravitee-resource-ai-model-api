...
public abstract class AiImageModelResource<C extends ResourceConfiguration, MODEL_RESULT, RESOURCE_RESULT>
    ...
    protected InferenceServiceClient<ImageInput, MODEL_RESULT> inferenceServiceClient;
    ...
    public abstract Single<RESOURCE_RESULT> invokeModel(ImageInput input);

    protected abstract InferenceServiceClient<ImageInput, MODEL_RESULT> buildInferenceServiceClient();
